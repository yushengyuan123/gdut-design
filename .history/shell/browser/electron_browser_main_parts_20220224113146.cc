...
void ElectronBrowserMainParts::PostEarlyInitialization() {
  ...
  // electron_bindings_是ElectronBindings类的一个实例，其BindTo方法为process对
  // 象提供了一系列的扩展方法和属性，比如process对象的getCPUUsage、crash、getCreationTime
  electron_bindings_->BindTo(js_env_->isolate(), env->process_object());

  // Load everything.
  // node_bindings对象的LoadEnvironment方法最终初始化Node.js的运行环境
