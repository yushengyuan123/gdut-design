...
class ElectronMainDelegate : public content::ContentMainDelegate {
 ...
 private:
  ...
  std::shared_ptr<content::ContentBrowserClient> browser_client_;
  std::shared_ptr<content::ContentClient> content_client_;
  std::shared_ptr<content::ContentGpuClient> gpu_client_;
  std::shared_ptr<content::ContentRendererClient> renderer_client_;
  std::shared_ptr<content::ContentUtilityClient> utility_client_;
  std::shared_ptr<tracing::TracingSamplerProfiler> tracing_sampler_profiler_;
};
