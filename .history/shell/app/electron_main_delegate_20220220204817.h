...
class ElectronMainDelegate : public content::ContentMainDelegate {
 ...
 private:
  ...
  unique_ptr<content::ContentBrowserClient> browser_client_;
  unique_ptr<content::ContentClient> content_client_;
  unique_ptr<content::ContentGpuClient> gpu_client_;
  unique_ptr<content::ContentRendererClient> renderer_client_;
  unique_ptr<content::ContentUtilityClient> utility_client_;
  unique_ptr<tracing::TracingSamplerProfiler> tracing_sampler_profiler_;
};
