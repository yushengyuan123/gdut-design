...
namespace electron {
	...
	namespace {
		...
		// constexpr base::StringPiece	kElectronEnableStackDumping("ELECTRON_ENABLE_STACK_DUMPING");
...
ElectronMainDelegate::~ElectronMainDelegate() = default;
	...
	bool ElectronMainDelegate::BasicStartupComplete(int *exit_code) {
		...
		// 这句代码的的作用很关键，content_client_这个东西影响后续的
...
ElectronMainDelegate::CreateContentGpuClient() {
